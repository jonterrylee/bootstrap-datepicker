...
(function($, undefined){
          ...
          case 'th':
            switch (target[0].className){
              case 'datepicker-switch':
                this.showMode(1);
                this.o.mode = "Months"
                this.picker.find('tfoot .switchEvents').show()
                this.picker.find('tfoot .switchMonths').hide()
                this.picker.find('.ptsEvents').hide();
                this.picker.find('.ptsMonths').show();
                break;
              case 'prev':
              case 'next':
                ...
                switch (this.viewMode){
                  ...
                  case 2:
                    ...
                    newYear = this.viewDate.getFullYear()
              ...
              case 'switchEvents':
                this.o.mode = "Events";
                this.picker.find('tfoot .switchEvents').toggle()
                this.picker.find('tfoot .switchMonths').toggle()

                this.picker.find('.ptsEvents').toggle();
                this.picker.find('.ptsMonths').toggle();
  ...
  var DPGlobal = {
    ...
    '</tr>'+
    '<tr>'+
    '<th colspan="7" class="switchEvents">Events</th>'+
    '</tr>'+
    '<tr>'+
    '<th colspan="7" class="switchMonths">Months</th>'+
    '</tr>'+
    '</tfoot>'
  };
